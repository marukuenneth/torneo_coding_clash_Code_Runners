...
let componenteX = parseInt(prompt('¡Determinaremos si las patadas al arco son GOL o no!\n Ingresa la posición de la pelota en X'))
let componenteY = parseInt(prompt('¡Determinaremos si las patadas al arco son GOL o no!\n Ingresa la posición de la pelota en Y'))
alert(`RESULTADO: ${arco(componenteX, componenteY)}\n\nPosición de la pelota en X: ${componenteX}\nPosición de la pelota en Y: ${componenteY}`)
